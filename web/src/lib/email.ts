  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;padding:40px 16px">
    <tr><td align="center">
      <table width="100%" style="max-width:520px;background:#141414;border-radius:16px;border:1px solid #222;overflow:hidden">
        <!-- Header -->
        <tr>
          <td style="background:linear-gradient(135deg,#FF5C38 0%,#FF8264 100%);padding:28px 32px">
        ...
        <tr>
          <td style="padding:20px 32px;border-top:1px solid #222;font-size:0.75rem;color:#555;text-align:center">
            © ${new Date().getFullYear()} DepMi · <a href="${APP_URL}" style="color:#FF5C38;text-decoration:none">depmi.com</a>
          </td>
        </tr>
      </table>
    </td></tr>
...
function btn(label: string, href: string): string {
    return `<a href="${href}" style="display:inline-block;margin-top:24px;padding:14px 28px;background:#FF5C38;color:#000;font-weight:700;font-size:0.95rem;border-radius:10px;text-decoration:none">${label}</a>`;
}
        ...
        await resend.emails.send({
            ...
            html: layout(`
                ...
                <p style="margin:0 0 24px;color:#aaa;line-height:1.6">
                    You just joined Africa's marketplace built on <strong style="color:#FF5C38">trust</strong>.
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding:14px 16px;background:#1a1a1a;border-radius:10px;margin-bottom:10px">
                            <span style="color:#FF5C38;font-weight:700">🔍 Search & discover</span>
                    ...
                    <tr>
                        <td style="padding:14px 16px;background:#1a1a1a;border-radius:10px">
                            <span style="color:#FF5C38;font-weight:700">📋 Post a request</span>
                    ...
                    <tr>
                        <td style="padding:14px 16px;background:#1a1a1a;border-radius:10px">
                            <span style="color:#FF5C38;font-weight:700">🏪 Open your store</span>
    ...
    try {
        await resend.emails.send({
            ...
            html: layout(`
                ...
                <div style="padding:16px;background:#1a1a1a;border-radius:10px;border-left:3px solid #FF5C38">
    ...
    try {
        await resend.emails.send({
            ...
            html: layout(`
                ...
                <div style="padding:16px;background:#1a1a1a;border-radius:10px;border-left:3px solid #FF5C38">
                    <p style="margin:0;color:#ccc;font-size:0.9rem">
                        <strong style="color:#FF5C38">Early access perk:</strong> Your account gets a
