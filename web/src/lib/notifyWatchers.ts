                ...
                resend.emails.send({
                    ...
                    html: `
                        <div style="font-family:sans-serif;max-width:480px;margin:auto">
                            <h2 style="color:#059669">Good news, ${escHtml(user.displayName)}!</h2>
                            ...
                            <a href="${productUrl}" style="display:inline-block;background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold;margin-top:8px">View Product →</a>
        ...
        watches.map(async (watch) => {
            ...
            if (user.email) {
                resend.emails.send({
                    ...
                    html: `
                        <div style="font-family:sans-serif;max-width:480px;margin:auto">
                            <h2 style="color:#059669">It's back, ${escHtml(user.displayName)}!</h2>
                            ...
                            <a href="${productUrl}" style="display:inline-block;background:#059669;color:#fff;padding:12px 28px;border-radius:8px;text-decoration:none;font-weight:bold;margin-top:8px">Buy Now →</a>
                            <p style="margin-top:24px;color:#999;font-size:12px">You're receiving this because you set a watch on DepMi. <a href="${BASE_URL}/notifications">Manage alerts</a></p>
                        </div>
                    `,
