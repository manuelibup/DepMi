...
function StatusBanner({ status }: { status: string }) {
    if (status === 'VERIFIED') return (
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(var(--primary-rgb),0.08)', border: '1px solid rgba(var(--primary-rgb),0.25)', borderRadius: '12px', padding: '14px 16px' }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}><polyline points="20 6 9 17 4 12" /></svg>
            <div>
                <p style={{ margin: 0, fontWeight: 700, color: 'var(--primary)', fontSize: '0.95rem' }}>Verified Store</p>
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
                ...
                {cacDocUrl ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(var(--primary-rgb),0.06)', border: '1px solid rgba(var(--primary-rgb),0.2)', borderRadius: '10px', padding: '10px 14px' }}>
            ...
            {submitted && (
                <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--primary)', background: 'rgba(var(--primary-rgb),0.08)', padding: '10px 14px', borderRadius: '10px', border: '1px solid rgba(var(--primary-rgb),0.2)' }}>
