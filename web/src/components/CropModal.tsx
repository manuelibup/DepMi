        ...
        <div style={{
            ...
            <div style={{
                ...
                <button
                    ...
                    disabled={processing}
                    style={{
                        background: 'var(--primary, var(--primary))', border: 'none',
                ...
                <div style={{ position: 'absolute', inset: 0, transform: flipH ? 'scaleX(-1)' : undefined }}>
                    <Cropper
                        ...
                        style={{
                            ...
                            cropAreaStyle: { borderColor: 'var(--primary, var(--primary))' },
                        }}
                    />
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <input
                        ...
                        style={{ flex: 1, accentColor: 'var(--primary, var(--primary))', cursor: 'pointer' }}
                    />
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '24px' }}>
                    ...
                    <button
                        ...
                        style={{ ...btnStyle, ...(flipH ? { color: 'var(--primary, var(--primary))' } : {}) }}
