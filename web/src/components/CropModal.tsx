        ...
        <div style={{
            ...
            <div style={{
                ...
                <button
                    ...
                    disabled={processing}
                    style={{
                        background: 'var(--primary, #00C853)', border: 'none',
                ...
                <div style={{ position: 'absolute', inset: 0, transform: flipH ? 'scaleX(-1)' : undefined }}>
                    <Cropper
                        ...
                        style={{
                            ...
                            cropAreaStyle: { borderColor: 'var(--primary, #00C853)' },
                        }}
                    />
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <input
                        ...
                        style={{ flex: 1, accentColor: 'var(--primary, #00C853)', cursor: 'pointer' }}
                    />
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '24px' }}>
                    ...
                    <button
                        ...
                        style={{ ...btnStyle, ...(flipH ? { color: 'var(--primary, #00C853)' } : {}) }}
